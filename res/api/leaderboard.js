...
const createTable = students => {
  ...
  // Leaderboard.
  let html = '<div class="table-container" id="table-container"><table id="leaderboard" class="leaderboard"> <tr> <th>Studentnummer</th> <th>Naam</th> <th>Score</th> <th>Datum</th> <th>Tijdstip</th> </tr><caption id="caption" class="caption">Leaderboard</caption>'
